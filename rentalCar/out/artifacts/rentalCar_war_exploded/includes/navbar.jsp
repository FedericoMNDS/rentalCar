    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="pages/parcoAuto.jsp">Parco Auto</a>
                </li>
                <%if (auth != null && auth.getRole().equals("ADMIN")) {%>
                <li class="nav-item">
                    <a class="nav-link" href="pages/listaCustomer.jsp">Customer(AD)</a>
                </li>
                <%}%>
            </ul>
            ...
            <div class="div-left">
                ...
                <a href="pages/registration.jsp" class="btn fLeft btn-secondary">Registrati</a></div>
            <%
            } else {
            %>
            <div class="div-left"><%
            ...
            %>
                ...
                <a href="pages/profiloUtente.jsp" class="btn fLeft btn-primary"><%out.print(auth.getName());%>
                </a>
                <%}%>
                <a href="logoutServlet" class="btn fLeft btn-danger">Logout</a>
                <%}%>
            </div>
        </div>
        <div class="modal fade" id="exampleModal" id="loginModal" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title titles" id="exampleModalLabel">Login</h5>
